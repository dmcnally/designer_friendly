class DesignerFriendlyGenerator < Rails::Generator::NamedBase
  def manifest
    ...
    record do |m|
      ...
      m.template 'views/forms/general.html.erb', "#{destination_path}/_general.html.erb"
      m.template 'views/forms/general_with_errors.html.erb', "#{destination_path}/_general_with_errors.html.erb"
